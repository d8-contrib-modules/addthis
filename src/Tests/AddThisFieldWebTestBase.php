...
/**
 * @file
 * Definition of Drupal\addthis\Tests\AddThisFieldWebTestBase.
 *
 * This code was taken from the field_example module in the
 * D8 examples module. Would be awesome if something like this was provided
 * by core.
 */
